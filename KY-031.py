...
MQTT_TOPIC = "utng/ky031"
MQTT_CLIENT_ID = "ESP32_KY031"
MQTT_PORT = 1883

# Configuración del sensor KY-031 en el pin 26
sensor_impacto = Pin(26, Pin.IN)
...
# Bucle principal: Detectar impactos y enviar estado por MQTT
