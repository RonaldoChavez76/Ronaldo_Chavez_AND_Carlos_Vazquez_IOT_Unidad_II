...
MQTT_TOPIC_A = "utng/ky036/analogico"
MQTT_TOPIC_D = "utng/ky036/digital"
...
while True:
    ...
    mensaje_a = "Sensibilidad táctil (A0): {}".format(valor_analogico)
    mensaje_d = "Contacto METÁLICO DETECTADO" if valor_digital == 1 else "No hay contacto"
