...
MQTT_TOPIC = "utng/ky022"
MQTT_CLIENT_ID = "ESP32_KY022"
MQTT_PORT = 1883

# Configuración del sensor KY-022 en el pin 33
sensor_ir = Pin(33, Pin.IN)
...
# Bucle principal: Detectar señales IR y enviar actualización por MQTT
...
while True:
    ...
    if estado_actual != estado_anterior:  # Solo enviar datos si hay cambio
        if estado_actual == 0:
            mensaje = "Señal IR DETECTADA"
        else:
            mensaje = "No hay señal IR"
