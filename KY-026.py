...
MQTT_TOPIC_A = "utng/ky026/analogico"
MQTT_TOPIC_D = "utng/ky026/digital"
...
while True:
    ...
    mensaje_a = "Intensidad de flama (A0): {}".format(valor_analogico)
    mensaje_d = "¡FLAMA DETECTADA!" if valor_digital == 1 else "No hay flama"
