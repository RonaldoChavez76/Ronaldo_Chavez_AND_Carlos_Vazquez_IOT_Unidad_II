...
MQTT_TOPIC_A = "utng/ky025/analogico"
MQTT_TOPIC_D = "utng/ky025/digital"
...
while True:
    ...
    mensaje_a = "Valor analógico del Reed Switch: {}".format(valor_analogico)
    mensaje_d = "Imán DETECTADO" if valor_digital == 1 else "Sin imán"
