...
MQTT_TOPIC_A = "utng/ky024/analogico"
MQTT_TOPIC_D = "utng/ky024/digital"
...
while True:
    ...
    mensaje_a = "Campo magnético (A0): {}".format(valor_analogico)
    mensaje_d = "Campo magnético DETECTADO" if valor_digital == 1 else "Sin campo magnético"
